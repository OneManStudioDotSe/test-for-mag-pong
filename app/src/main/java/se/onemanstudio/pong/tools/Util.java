...
package se.onemanstudio.pong.tools;
...
public class Util {
    ...
    public static int createImageTexture(ByteBuffer data, int width, int height, int format) {
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, textureHandle);// Bind the texture handle to the 2D texture target.
    ...
    public static int loadShader(int type, String shaderCode) {
        ...
        if (compileStatus[0] != GLES20.GL_TRUE) {
            String msg = GLES20.glGetShaderInfoLog(shaderHandle);// Extract the detailed failure message.
